...
void sdl_draw_jkimyei_policy(__iicu_wikimyei_t *_iicu_wikimyei){
    ...
    latest_alliu_relative_y=(int)((_staticques->__alliu_latest*(0x01-_jkimyei->__jk_inteligent_order_policy->__order_margin_down)-main_box_min)*((__cwcn_type_t)_nijcyota->main_box_h)/(main_box_max-main_box_min+1e-9));
    latest_alliu_relative_y=(int)((_staticques->__alliu_latest*(0x01+BROKER_MARKET_TOTAL_COMMISSION)-main_box_min)*((__cwcn_type_t)_nijcyota->main_box_h)/(main_box_max-main_box_min+1e-9));
    sprintf(aux_caption,"-----------------------------");
    ...
    sdl_draw_text(aux_caption, // alliu magin of max loss
        ...
        _nijcyota->negative_color,_obj_sdl->screen_font,_obj_sdl->renderer);
    sprintf(aux_caption,"+++++++++++++++++++++++++++++");
    latest_alliu_relative_y=(int)((_staticques->__alliu_latest*(0x01+_jkimyei->__jk_inteligent_order_policy->__order_margin_up)-main_box_min)*((__cwcn_type_t)_nijcyota->main_box_h)/(main_box_max-main_box_min+1e-9));
